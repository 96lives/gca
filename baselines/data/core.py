...
import numpy as np
import yaml
from baselines.common import decide_total_volume_range, update_reso
...
class Field(object):
    ...
    def load(self, data_path, idx, category, obj_min_rate):
        ''' Loads a data point.
        ...
        Args:
            ...
            obj_min_rate (float): used for cutting pointcloud field in spheres
        '''
...
class Shapes3dDataset(data.Dataset):
    ...
    def __init__(self, dataset_folder, fields, split=None,
        ...
        self.cfg = cfg
        self.obj_min_rate = self.cfg['data']['obj_min_rate']
    ...
    def __getitem__(self, idx):
        ...
        for field_name, field in self.fields.items():
            try:
                field_data = field.load(model_path, idx, info, self.obj_min_rate)
            except Exception:
                if self.no_except:
                    logger.warn(
